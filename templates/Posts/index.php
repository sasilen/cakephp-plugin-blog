    ...
    <div class="card-columns">
        ...
        <div class="card">
            <div class="card-header text-muted">
                ...
                <?= $this->AuthLink->link($this->Html->image('Blog.ic_mode_edit_black_24px.svg'),['plugin'=>'Sasilen/Blog','controller'=>'posts','action' => 'edit',$post->id],['escape'=>false]);?>
                <?php if ($this->AuthLink->isAuthorized(['plugin'=>'Sasilen/Blog','controller'=>'posts','action' => 'delete',$post->id])) : ?>
